                    ...
                    <div class="panel-body">
                        <div class="row">
                            <?php foreach ($user_posts as $posts) { ?>
                                <div class="col-md-4">
                                    <div class="thumbnail">
                                        <?php if (isset($posts['attachment_path']) && !empty($posts['attachment_path'])) { ?>
                                            <img src="<?php echo base_url('uploads/images') . '/' . $posts['attachment_path'] ?>" class="img-rounded" alt="<?php echo $posts['COMMENTS']; ?>" width="304" height="236"> 
                                        <?php } ?>
                                        <div class="caption">
                                            <h3><?php echo $posts['COMMENTS']; ?></h3>
